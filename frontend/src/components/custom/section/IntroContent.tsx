export default function IntroContent() {
  return (
    <section className="p-4 dark:bg-black dark:text-gray-100">
      <div className="bg-gradient-to-r from-blue-700 to-blue-500 max-w-8xl mx-auto min-h-[350px] rounded-3xl p-6 flex flex-col justify-center overflow-hidden">
        <div className="grid md:grid-cols-2 justify-center items-center max-md:text-center md:gap-8 gap-16 h-full">
          <div className="md:max-w-md mx-auto">
            <h2 className="text-white text-4xl md:text-5xl font-extrabold mb-6 md:!leading-[55px]">Try using our templates</h2>
            <p className="text-white text-base">Upgrade to our premium plan and supercharge your experience. Don't miss out!</p>
            
          </div>
          <div className="md:text-right">
            <img src="https://readymadeui.com/bg-image.webp" alt="Premium Benefits"  className="object-fit h-[350px]" />
          </div>          
        </div>        
